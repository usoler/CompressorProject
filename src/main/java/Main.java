...
public class Main {
    ...
    private static final String pathTest = "input/snail.ascii.ppm";
    ...
    public static void main(String[] args) throws IOException {
        ...
        String pathnameEncoded = "output/JPEGTest/snail.ascii.jpeg";
        ...
        String pathnameDecoded = "output/JPEGTest/snail.ppm";
